 ...
 *    notifications.
 * 2. internal storage - for persistence between subscribe and callback invokation
...
public class WebSubSubscriber {
    ...
    final private WebSubSubscriptionRegistry registry;
    ...
    private static class HubParams {
        final static String CALLBACK = "hub.callback";
        final static String CHALLENGE = "hub.challenge";
        final static String LEASE_SECONDS = "hub.lease_seconds";
        final static String MODE = "hub.mode";
        final static String REASON = "hub.reason";
        final static String SECRET = "hub.secret";
        final static String TOPIC = "hub.topic";
    }
     ...
     *
     * Applicable requests may be determined by e.g. URL prefix.
     */
    ...
    public DiscoverResponse discover(String topicUrl)
        ...
        if ("text".equals(mediaType.getType()) && "html".equals(mediaType.getSubType())) {
            ...
            String contents = getHttpResponseBody(response);
